...
/**
 * This class is for stone walls. They have rectangular shapes! Set where you
 * want their corners to be and the game will determine the appropriate
...
public class Wall extends Solid {
	...
	public Wall(double x, double y, double width, double height) {
		...
		moveTo(x + (width * 0.5), y + (height * 0.5),
				Game.getIntersectingTiles(this, x + (width * 0.5), y + (height * 0.5)));
	}

	/**
	 * This method makes a wall spanning from (x0,y0) to (x0+dx,y0+dx) Note that
	 * [(dx == 0) || (dy == 0)] A horizontal wall will have width exactly equal to
	 * dx, but height of "thickness," and will be vertically centered on y If "door"
	 * is >0, it will place a doorway with width "door" in the middle of the wall
	 **/
