...
/**
 * WanderingTalkers wander within a given area. When they see you, they will
 * stop to talk. "message" determines what they say.
 * 
 * They have an "image," which must be given to them. It is not assigned by the
 * constructor!
 * 
...
abstract class WanderingTalker extends Navigator {
	...
	/**
	 * wx, wy, ww, wh refer to the corner and dimensions of the area in which this
	 * wanders. This will initially be placed in the exact center of this space.
	 **/
