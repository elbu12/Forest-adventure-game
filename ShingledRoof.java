...
public class ShingledRoof extends Solid {
	...
	public ScaledImage draw() {
		if (image == null) {
			image = new BufferedImage((int) (width * Game.tileWidth), (int) (height * Game.tileHeight),
			...
			g.setColor(Color.BLACK);
			g.fillRect((image.getWidth() / 2) - (shingleWidth * 3 / 2) + 8, topOfChimney + 8, (shingleWidth * 3) - 16,
					(shingleHeight * 6) - 16);
		}
