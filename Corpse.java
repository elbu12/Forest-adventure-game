...
public class Corpse extends Solid {
	...
	private void takeSword() {
		Game.globals.haveSword = true;
		shape = Game.NULL;
		Game.makePermanentMessage("You take the sword",
				"You many now press c to toggle combat mode.\n\n"
